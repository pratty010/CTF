# Write Ups for the Advent of Cyber 2 [2020] daily challenges.
...
Each task is beginner friendly and assumes no prior knowledge about the specific topic. You'll be learning about the following topics:
