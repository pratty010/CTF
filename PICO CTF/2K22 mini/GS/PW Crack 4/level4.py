"""
Solution for the Pico-mini CTF 2K22 General Skill Challenge - PW Crack 4.

Description: Can you crack the password to get the flag?
Download the password checker here and you'll need the encrypted flag and the hash in the same directory too.
There are 7 potential passwords with 1 being correct. You can find these by examining the password checker script.

Solution: Same as PW Check 3 but way more passwords.
...
# def my_level_4_pw_check(password):
#     user_pw = password
#     user_pw_hash = hash_pw(user_pw)
