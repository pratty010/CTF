"""
Solution for the Pico-mini CTF 2K22 General Skill Challenge - Serpentine.

Description: Find the flag in the Python script!

Solution: Bad development work. The choice b din't have the print_flag() fn invoked. Made the change and voila, flag came to us.
